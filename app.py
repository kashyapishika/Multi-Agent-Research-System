...
.hero-eyebrow { font-family:'DM Mono',monospace; font-size:0.7rem; font-weight:500; letter-spacing:0.25em; text-transform:uppercase; color:#ff8c32; margin-bottom:1rem; }
...
.input-card { background:rgba(255,255,255,0.03); border:1px solid rgba(255,140,50,0.15); border-radius:16px; padding:2rem 2.5rem; margin-bottom:2rem; }
...
.stButton > button { background:linear-gradient(135deg,#ff8c32 0%,#ff5a1a 100%)!important; color:#0a0a0f!important; font-family:'Syne',sans-serif!important; font-weight:700!important; font-size:0.95rem!important; border:none!important; border-radius:10px!important; padding:0.7rem 2.2rem!important; box-shadow:0 4px 20px rgba(255,140,50,0.3)!important; width:100%; }
.stButton > button:hover { transform:translateY(-2px)!important; box-shadow:0 8px 28px rgba(255,140,50,0.4)!important; }
.step-card { background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.07); border-radius:14px; padding:1.5rem 1.8rem; margin-bottom:1.2rem; position:relative; overflow:hidden; }
...
st.markdown("""
<div class="hero">
    <div class="hero-eyebrow">Multi-Agent AI System &nbsp;·&nbsp; 100% Free Stack</div>
    <h1>Research<span>Mind</span></h1>
    <p class="hero-sub">
        Four specialized AI agents collaborate — searching, scraping, writing,
        and critiquing — to deliver a polished research report on any topic.<br><br>
        <span style="font-size:0.82rem;color:#50c878;">
            ✓ Groq (Llama 3.3 70B) &nbsp;·&nbsp; ✓ DuckDuckGo Search &nbsp;·&nbsp; ✓ No paid APIs
        </span>
    </p>
</div>
...
with col_pipeline:
    ...
    step_card("01", "Search Agent", s("search"), "DuckDuckGo – no API key needed")
...
st.markdown('<div class="notice">ResearchMind · Groq (Llama 3.3-70B) + DuckDuckGo · LangGraph · Streamlit · 100% Free</div>', unsafe_allow_html=True)
